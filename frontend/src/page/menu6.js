    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.menuContainer}>
        ...
        <TouchableOpacity style={styles.item} onPress={() => addToCart("Comida 7")}>
          <Text>Enchiladas de pollo y queso</Text>
          <Text>$15</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.item} onPress={() => addToCart("Comida 2")}>
          <Text>Panuchos de asada</Text>
          <Text>$15</Text>
        </TouchableOpacity>
        ...
        <TouchableOpacity style={styles.item} onPress={() => addToCart("Comida 8")}>
          <Text>Tamales de pollo</Text>
          <Text>$15</Text>
        </TouchableOpacity>
