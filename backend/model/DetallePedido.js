...
async function main() {
  try {
    ...
    // const detallePedido = await readDetallePedido(nuevoDetallePedido.id);
    // console.log("Detalle de pedido encontrado:", detallePedido);

    // Actualizar el detalle de pedido recién creado
    // const detallePedidoActualizado = await updateDetallePedido(nuevoDetallePedido.id, { cantidad: 3 });
    // console.log("Detalle de pedido actualizado:", detallePedidoActualizado);

    // Eliminar el detalle de pedido
    // await deleteDetallePedido(nuevoDetallePedido.id);
